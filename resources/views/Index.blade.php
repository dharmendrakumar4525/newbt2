...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="owl-carousel owl-theme slidercard2 pt-5 pb-5">
  ...
  <div class="container mt-5 mb-5">
    <div class="row knowusallcontent">
      <div class="col-md-6 col-sm-12 mb-3">
        ...
        <a href="Aboutus.html"><button class="knowusbtn">Know More</button></a>
      </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 mt-2">
        <div class="card text-white whychooseusimg">
          <!-- <figure>
              <img src="pictures/w1.png" class="card-img" alt="..." />
            </figure>
            <div class="card-img-overlay">
              <p class="card-text imgtext">
                Organized team with regional sales manager
              </p>
            </div> -->
