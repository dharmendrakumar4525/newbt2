...
<div class="container-fluid bg-white text-black headercontainer">
  ...
  <div class="container mt-5 mb-5">
    <p class="retailmainhead">Maison De Parfums</p>
  </div>
  ...
  <div class="container mt-5 mb-5">
    <p class="retailmainhead">Beauty Luxe</p>
  </div>
  <div class="container-fluid">
    <div class="row m-5">
      <div class="left">
      ...
      <div class="right">
        <p class="retailtext">
          ...
          <br><br>
          Beauty Luxe is a luxury retail store that houses Luxury and Niche brands reaching out to the most discerning
