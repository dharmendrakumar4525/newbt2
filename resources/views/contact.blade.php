...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 pt-5">
        <div id="map">
          <div class=" mt-3">
            <img src="/pictures/Group-map.png" width="100%" alt="Map">
          </div>
          <div id="dots">
 ...
 <div class="form-group">
        <label>Message</label>
        <textarea class="form-control fmessage  {{ $errors->has('message') ? 'error' : '' }}" name="message" id="message"
            rows="4"></textarea>
        ...
        @endif
            ...
            <label class="main">Verified user
              <input type="checkbox" />
